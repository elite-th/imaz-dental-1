...
const faData: Record<string, Record<string, string>> = {
  ...
  faq: {
    ...
    q6: "چرا باید دکتر سیاه‌نوری را انتخاب کنم؟", a6: "بیش از ۷ سال تجربه حرفه‌ای، تمرکز ویژه بر ایمپلنت و درمان ریشه، تجهیزات مدرن، و طرح درمان اختصاصی برای هر بیمار."
  },
  whyimaz: {
    ...
    feat1_title: "بیش از ۷ سال تجربه", feat1_desc: "تمرکز ویژه بر ایمپلنت و درمان‌های پیشرفته ریشه",
